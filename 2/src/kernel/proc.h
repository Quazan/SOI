...
struct proc {
  ...
  int user_priority;		/* process priority set by user, <0 NORMAL, >0 PRIORITY  */
...
/* Values for user_priority */
#define NORMAL          0	/* Normal priority */
#define PRIORITY	1	/* Higher priority */
